...
export default function useTnRepoValidation({authentication, owner, server, languageId, refresh}) {
  const [{tnRepoTree, 
    ...
    tnRepoTreeStatus}, 
    setValues
  ] = useState({tnRepoTree:null, tnRepoTreeManifest:null, tnManifestSha:null, tnRepoTreeStatus:WAITING})
  ...
  useEffect(() => {
    async function getReposTrees() {
      ...
      setValues({tnRepoTree: _tree, tnRepoTreeManifest: _manifest, tnManifestSha: _manifestSha, tnRepoTreeStatus: _errorMesage})
    }
